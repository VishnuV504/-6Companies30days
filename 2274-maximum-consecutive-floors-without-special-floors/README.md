...
<pre style="position: relative;"><strong>Input:</strong> bottom = 2, top = 9, special = [4,6]
...
<pre style="position: relative;"><strong>Input:</strong> bottom = 6, top = 8, special = [7,6,8]
