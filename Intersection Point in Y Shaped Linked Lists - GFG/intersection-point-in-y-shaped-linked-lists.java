...
class Intersect
{
	...
	{
         // code here
         int len=0; int len2=0; Node temp=head1; Node temp2=head2;
         while(temp!=null){
             len++;
             temp=temp.next;
         }
         ...
         if(len>len2){
             int diff=len-len2; int count=0; temp=head1; temp2=head2;
             while(count<diff){
                 count++;
                 temp=temp.next;
             }
             ...
             int diff=len2-len; int count=0; temp2=head2; temp=head1;
             while(count<diff){
                 count++;
                 temp2=temp2.next;
             }
